...
include "koneksi.php";
//Create Autonumber
$sql = "SELECT MAX(Kode) AS id FROM M_Insiden";
    ...
    <div class="container">
      <div class="row">
        <div class="span12 mainPage">
          ...
          <br>
          <span class="style1">Create Insiden </span><br>
          <table>
            <tr>
              <td>Kode Insiden</td>
              <td> : </td>
              <td><input name="kodeInsiden" type="text" id="kd_insiden" maxlength="3" disabled="disabled" value="<?php echo $id;?>" size="8" maxlength="6" readonly="readonly"
        style="text-align:center;font-weight:bold;font-size:16px" /></td>
            </tr>
            <tr>
              <td>Deskripsi</td>
              <td> : </td>
              <td><input type="text" id="desk_insiden" name="deskripsi" maxlength="50"></td>
            </tr>
            <tr>
              <td>Status</td>
              <td>:</td>
            ...
            <tr>
              <td height="43">&nbsp;</td>
              <td>&nbsp;</td>
              <td colspan="2"><button onClick="saveinsiden();">Save</button>  
