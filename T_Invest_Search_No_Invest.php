...
<div id="myModal" class="modala">
  ...
  <div class="modala-content">
    <div class="modala-header">
      ...
      <h2>Filter Data Invest</h2>
  </div>
  <div class="modala-body">
      <p>Pilih data Invest yang dimaksud</p>
      <table>
          <tr>
              <td>Masukan No. Invest atau Tindak Lanjut Laporan</td>
              <td> : </td>
...
$(document).ready(function(){
    ...
    {
        $("#tampiltabel").load('T_Invest_Table_No_Invest.php?katakunci='+$("#katakunci").val());
    });
});
...
function cekKataKunci(){
    ...
    window.location.href='T_Invest_Search_No_Invest.php?katakunci=' + katakunci;
}
