    ...
    <div class="container">
      <div class="row">
        <div class="span12 mainPage">
          ...
          <br>
          <span class="style1">Create Unit </span><br>
          <table>
            <tr>
              <td>Kode Unit</td>
              <td> : </td>
              <td><input name="kodeunit" type="text" id="kd_unit" maxlength="6" disabled=""></td>
            </tr>
            <tr>
              <td>Deskripsi</td>
              <td> : </td>
            ...
            <tr>
              <td height="43">&nbsp;</td>
              <td>&nbsp;</td>
              <td colspan="2"><button onClick="saveunit();">Save</button>  
