...
<script type="text/javascript" src="libs/jquery.min.js"></script>
		<script type="text/javascript">
			$(document).ready(function()
			{
				...
				{	
					$.getJSON('U_User_Display.php',{action:'getUnker', kode_dept:$(this).val()}, function(json)
					{	
						$('#unit_kerja').html('');
    ...
    <div class="container">
      <div class="row">
        <div class="span12 mainPage">
					...
					<br>
					<span class="style1">Display User </span><br>
					<table>
						<tr>
							<td>ID</td>
							<td> : </td>
						...
						<tr>
							<td>Departemen</td>
							<td> : </td>
							<td><select id="departemen" name="departemen" disabled="disabled">
						...
						<tr>
						  <td>Aktif</td>
						  <td>: </td>
						  <td colspan="2"><input type="radio" name="statuser" id="aktif" checked disabled>
					      Aktif</td>
					  </tr>
						<tr>
						  <td height="50">&nbsp;</td>
						  <td>&nbsp;</td>
						  <td colspan="2"><input type="radio" name="statuser" id="nonaktif" disabled>
					      Non-Aktif</td>
					  </tr>
						<tr>
							<td>&nbsp;</td>
							...
							<button onClick="clearuser();">Reset</button>							</td></td>
						</tr>
					</table>
...
<script>
    ...
    if (id_user) {
      window.location.href='U_User_Save.php?id_user=' + id_user + '&departemen=' + departemen + '&unit_kerja=' + unit_kerja + '&statuser=' + statuser + '&simpan=' + simpan;
    } else {
