...
#ambil data indikator
  $query = "SELECT * FROM M_Indikator WHERE Unit= '$kode_unit' AND status='X'";
  $sql = sqlsrv_query($conn, $query);
  $arrind = array();
  while ($row = sqlsrv_fetch_array($sql)) {
      ...
      <tr>
        ...
        <tr>
          ...
          <td colspan="2">
            ...
            <input type="text" id="text_layanan" name="tipe_layanan" maxlength="50" >          </td>
        </tr>
          <td>&nbsp;</td>
        <tr>
        ...
        <tr>
          ...
          <td colspan="2"><input onclick="enable2('cedera_lain')" type="radio" name="tingkat_cidera" id="lain" value="lain">Lainnya&nbsp;
            <input  type="text" id="text_cidera" name="tingkat_cidera" maxlength="50"></td>
        </tr>
          <td>&nbsp;</td>
        <tr>
