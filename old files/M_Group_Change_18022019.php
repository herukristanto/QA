    ...
    <div class="container">
      <div class="row">
        <div class="span12 mainPage">
					...
					<br>
					<span class="style1">Change Group </span><br>
					<table>
						<tr>
							<td>Kode Group </td>
							<td> : </td>
						...
						<tr>
							...
							<td colspan="2"><button id="myBtn">Search</button>  
											...
											<button onClick="cleargroup();">Cancel</button>  </td>
						</tr>
					</table>
...
<script>
	function savegroup(){
		...
		if (desk_group) {
			window.location.href='M_Group_Save.php?kd_group=' + kd_group + '&desk_group=' + desk_group + '&departemen=' + departemen + '&unitkerja=' + unitkerja +'&statgroup=' + statgroup;
		} else {
