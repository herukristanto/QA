...
if (isset($_GET['katakunci']))
{
    ...
    $query = "SELECT * FROM M_Indikator WHERE Kode like '%". $katakunci ."%' OR Aspek like '%". $katakunci ."%' OR Standar like '%". $katakunci ."%' OR Departemen like '%". $katakunci ."%' OR Unit like '%". $katakunci ."%' OR Status like '%". $katakunci ."%'";
