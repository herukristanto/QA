...
<div id="myModal" class="modala">
  ...
  <div class="modala-content">
    <div class="modala-header">
      ...
      <h2>Filter Data Tipe Insiden</h2>
  </div>
  <div class="modala-body">
      <p>Pilih data Tipe Insiden yang dimaksud</p>
      <table>
          <tr>
              <td>Masukan Kode atau Deskripsi Tipe Insiden</td>
              <td> : </td>
...
$(document).ready(function(){
    ...
    {
        $("#tampiltabel").load('M_Tipe_Insiden_Table.php?katakunci='+$("#katakunci").val());
    });
});
...
function cekKataKunci(){
    ...
    window.location.href='M_Tipe_Insiden_Search.php?katakunci=' + katakunci;
}
