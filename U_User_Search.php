...
<div id="myModal" class="modala">
  ...
  <div class="modala-content">
    <div class="modala-header">
      ...
      <h2>Filter Data User</h2>
  </div>
  <div class="modala-body">
      <p>Pilih data User yang dimaksud</p>
      <table>
          <tr>
...
$(document).ready(function(){
    ...
    {
        $("#tampiltabel").load('U_User_Table.php?katakunci='+$("#katakunci").val());
    });
});
...
function cekKataKunci(){
    ...
    window.location.href='U_User_Search.php?katakunci=' + katakunci;
}
