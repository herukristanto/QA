        ...
        <div class="span12 mainPage">
          ...
          <table>
            ...
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No. RCA</td>
              <td> : </td>
              <td><input type="text" id="no_rca" name="no_rca" style="text-align:center;font-weight:bold;font-size:14px" disabled="disabled"></td>
            ...
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tanggal</td>
              <td> : </td>
               <td><input name="TglObs" disabled="disabled" type="text" id="TglObs" maxlength="15" style="text-align:center;font-weight:bold;font-size:14px"/></td>
            </tr>
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jam</td>
              <td> : </td>
              <td><input type="text" disabled="disabled" id="jam_obs" name="jam_obs" maxlength="50" style="text-align:center;font-weight:bold;font-size:14px"></td>
            </tr>
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hasil</td>
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea name="hasil_obs" rows="3" id="hasil_obs" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="laporan_kejadian" id="laporan_kejadian" disabled="disabled">
              Laporan Kejadian</td>
            </tr>
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="berkas_RM" id="berkas_RM" disabled="disabled">
            ...
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tanggal</td>
              <td> : </td>
               <td><input name="TglWaw" type="text" id="TglWaw" disabled="disabled" maxlength="10" style="text-align:center;font-weight:bold;font-size:14px"/></td>
            </tr>
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jam</td>
              <td> : </td>
              <td><input type="text" id="jam_waw" name="jam_waw" disabled="disabled" maxlength="50" style="text-align:center;font-weight:bold;font-size:14px"></td>
            </tr>
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hasil</td>
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea name="hasil_waw" rows="4" id="hasil_waw" disabled="disabled"></textarea></td>
            </tr>
             <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea name="peta_informasi" rows="4" id="peta_informasi" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea name="masalah" rows="4" id="masalah" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea name="analisis" rows="4" id="analisis" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td><input name="TglAna1" type="text" id="TglAna1" disabled="disabled" maxlength="10" style="text-align:center;font-weight:bold;font-size:14px"/></td>
              <td>s/d</td>
              <td><input name="TglAna2" type="text" id="TglAna2" disabled="disabled" maxlength="10" style="text-align:center;font-weight:bold;font-size:14px"/></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea name="masalah_utama" rows="4" id="masalah_utama" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea name="saran_rekomendasi" rows="4" id="saran_rekomendasi" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td height="43">&nbsp;</td>
              <td>&nbsp;</td>
              <td colspan="2"><button onClick="clearinvest();">Reset</button></td>
            </tr>
