        ...
        <div class="span12 mainPage">
          ...
          <table>
            ...
            <tr>
              <td>No. Invest</td>
              <td> : </td>
              <td><input name="no_invest" type="text" id="no_invest" style="text-align:center;font-weight:bold;font-size:14px" disabled="disabled"></td>
              <td colspan="2"><button id="myBtn">Search</button> &nbsp;
                <?php include "T_Invest_Search_No_Invest.php"; ?></td>
            </tr>
            <tr>
              <td>No. Laporan</td>
              <td> : </td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea rows="4" id="penyebab_langsung" name="penyebab_langsung" value="penyebab_langsung" maxlength="50" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea rows="4" id="akar_masalah" name="akar_masalah" value="akar_masalah" maxlength="50" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea rows="4" id="tindakan" name="tindakan" value="tindakan" maxlength="50" disabled="disabled"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td><input name="perkiraan_waktu_1" type="text" id="perkiraan_waktu_1" disabled="disabled" value="<?php
            ...
            <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Perkiraan waktu pelaksanaan</td>
              <td> : </td>
              <td><input name="perkiraan_waktu_2" type="text" id="perkiraan_waktu_2" disabled="disabled" value="<?php
             if(isset($app['App_Date']))
               {echo $app['App_Date']->format('d/m/Y');}
             else
               {echo date('d/m/Y');} ?>" maxlength="15" style="text-align:center;font-weight:bold;font-size:14px"/></td>
           ...
           <!--  <tr>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td colspan="2">
                <!-- <button onClick="saveinvest();">Save</button> -->  
