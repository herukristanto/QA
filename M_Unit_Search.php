...
<div id="myModal" class="modala">
  ...
  <div class="modala-content">
    <div class="modala-header">
      ...
      <h2>Filter Data Unit</h2>
  </div>
  <div class="modala-body">
      <p>Pilih data Unit yang dimaksud</p>
      <table>
          <tr>
              <td>Masukan Kode atau Deskripsi Unit</td>
              <td> : </td>
...
$(document).ready(function(){
    ...
    {
        $("#tampiltabel").load('M_Unit_Table.php?katakunci='+$("#katakunci").val());
    });
});
...
function cekKataKunci(){
    ...
    window.location.href='M_Unit_Search.php?katakunci=' + katakunci;
}
