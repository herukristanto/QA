...
<div id="myModal" class="modala">
  ...
  <div class="modala-body">
      <p>Pilih data Insiden yang dimaksud</p>
      <table>
          <tr>
              <td>Masukan Kode atau Insiden</td>
              <td> : </td>
...
$(document).ready(function(){
    ...
    {
        $("#tampiltabel").load('M_Insiden_Table.php?katakunci='+$("#katakunci").val());
    });
});
...
function cekKataKunci(){
    ...
    window.location.href='M_Insiden_Search.php?katakunci=' + katakunci;
}
