...
<div id="myModal" class="modala">
  ...
  <div class="modala-body">
      <p>Pilih Data Indikator yang dimaksud</p>
      <table>
          <tr>
              <td>Masukan Kode atau Deskripsi Indikator</td>
              <td> : </td>
...
$(document).ready(function(){
    ...
    {
        $("#tampiltabel").load('M_Indikator_Table.php?katakunci='+$("#katakunci").val());
    });
});
...
function cekKataKunci(){
    ...
    window.location.href='M_Indikator_Search.php?katakunci=' + katakunci;
}
