...
include "koneksi.php";
 ...
 $tahun    = $_POST['tahun'];
   ...
   if(isset($bulan) && isset($tahun)){
     $query = "SELECT * FROM T_Kejadian WHERE month(Tgl)= $bulan && year(Tgl)= $tahun ORDER BY Indikator ASC";

  }elseif (isset($bulan)) {
    $query = "SELECT * FROM T_Kejadian WHERE month(Tgl)= $bulan ORDER BY Indikator ASC";
  }elseif (isset($tahun)) {
    $query = "SELECT * FROM T_Kejadian WHERE YEAR(Tgl)= $bulan ORDER BY Indikator ASC";
  }else {
    $query = "SELECT * FROM T_Kejadian ORDER BY Indikator ASC";
  }
  //OR month(tgl_input)='$bulan' OR year(tgl_input)='$tahun'
  $query = "SELECT * FROM T_Kejadian WHERE month(Tgl)= $bulan && year(Tgl)= $tahun ORDER BY Indikator ASC";
