...
echo "$kode_u";
  ...
  if (isset($bulan) OR isset($tahun) OR isset($unit)) {
    // $query = "SELECT * FROM T_Kejadian WHERE month(Tgl)= $bulan AND YEAR(Tgl)= $tahun AND kode_u = $kode_u ORDER BY Indikator ASC";
