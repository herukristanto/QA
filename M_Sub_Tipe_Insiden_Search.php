...
<div id="myModal" class="modala">
  ...
  <div class="modala-content">
    <div class="modala-header">
      ...
      <h2>Filter Data Insiden</h2>
  </div>
  <div class="modala-body">
      <p>Pilih data Sub Tipe Insiden yang dimaksud</p>
      <table>
          <tr>
              <td>Masukan Kode atau Deskripsi Sub Tipe Insiden</td>
              <td> : </td>
...
$(document).ready(function(){
    ...
    {
        $("#tampiltabel").load('M_Sub_Tipe_Insiden_Table.php?katakunci='+$("#katakunci").val());
    });
});
...
function cekKataKunci(){
    ...
    window.location.href='M_Sub_Tipe_Insiden_Search.php?katakunci=' + katakunci;
}
