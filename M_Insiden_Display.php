      ...
      <div class="row">
        ...
        style="text-align:center;font-weight:bold;font-size:16px" /></td>
						...
						<tr>
							<td>Deskripsi</td>
							<td> : </td>
							<td><textarea name="deskripsi" disabled id="desk_insiden"></textarea></td>
						</tr>
						<tr>
						  <td>Aktif</td>
						  <td>: </td>
						  <td colspan="2"><input type="radio" name="statinsiden" id="aktif" checked disabled>
					      Aktif</td>
					  </tr>
						<tr>
						  <td height="50">&nbsp;</td>
						  <td>&nbsp;</td>
						  <td colspan="2"><input type="radio" name="statinsiden" id="nonaktif" disabled>
					      Non-Aktif</td>
					  </tr>
						<tr>
							<td>&nbsp;</td>
