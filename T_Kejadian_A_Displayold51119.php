      ...
      <tr>
        ...
        <tr>
          ...
          <td colspan="2">
            ...
            <input type="text" id="text_layanan" name="rawat_lain" maxlength="50" disabled="disabled">          </td>
        </tr>
          <td>&nbsp;</td>
        <tr>
        ...
        <tr>
          ...
          <td colspan="2"><input disabled="disabled" type="radio" name="tingkat_cidera" id="lain" value="lain">Lainnya&nbsp;
            <input type="text" id="text_cedera" name="cedera_lain" maxlength="50" disabled="disabled"></td>
        </tr>
          <td>&nbsp;</td>
        <tr>
