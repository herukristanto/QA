    ...
    <tr>
      ...
      <tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="2"><input type="radio" name="kjd_terjadi" id="kjd_tidak" value="Tidak">
            Tidak</td>
          <td>&nbsp;</td>
          <td colspan="2">&nbsp;</td>
        </tr>
      ...
      <tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="2"><input type="radio" name="pasien_tahu" id="pasien_tidak" value="Tidak">
            Tidak</td>
          <td>&nbsp;</td>
          <td colspan="2">&nbsp;</td>
        </tr>
      ...
      <tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="2"><input type="radio" name="cedera" id="cedera_tidak" value="Tidak" >
            Tidak</td>
          <td>&nbsp;</td>
          <td colspan="2">&nbsp;</td>
          <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="radio" name="hasil" id="KNC" value="KNC" >
          KNC</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="radio" name="hasil" id="KPC" value="KPC" >
          KPC</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="radio" name="hasil" id="KTD" value="KTD" >
          KTD</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="radio" name="hasil" id="Sentinel" value="Sentinel" >
          Sentinel</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <tr>
          <td>Tipe Layanan</td>
          <td colspan="2">
            <input type="radio" name="tipe_layanan" id="rawatinap" value="Rawat Inap">Rawat Inap          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">
            <input type="radio" name="tipe_layanan" id="rawatjalan" value="Rawat Jalan">Rawat Jalan          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">
            <input type="radio" name="tipe_layanan" id="rawatlain" value="Rawat Lain">Lainnya &nbsp;
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2"><input  type="radio" name="tingkat_cidera" id="lain" value="lain">Lainnya&nbsp;
        ...
        <tr>
          ...
          <td> : </td>
          <td><input type="text" id="hasil_skor" name="hasil_skor" style="text-align:center;font-weight:bold;font-size:14px;color:red" disabled="disabled" maxlength="15" ></td>
        </tr>
        <tr>
          <td height="43">&nbsp;</td>
          <td>&nbsp;</td>
