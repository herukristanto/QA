        ...
        <div class="span12 mainPage">
					...
					<table>
					  ...
					  <tr>
			              ...
			              <td>:</td>
			              <td colspan="2"><input type="radio" name="statlap" id="Ya_lap" checked disabled="disabled">
			              Ya</td>
			            </tr>
			            <tr>
			              <td height="24">&nbsp;</td>
			              <td>&nbsp;</td>
			              <td colspan="2"><input type="radio" name="statlap" id="Tidak_lap" disabled="disabled">
			              Tidak</td>
			            </tr>
			            <tr>
			              <td>Indikator</td>
			            ...
			            <tr>
			              <td>Numerator</td>
			              <td> : </td>
			              <td colspan="2"><input type="radio" name="statnum" id="Ya_num" checked disabled="disabled">Ya</td>
			            </tr>
			            <tr>
			              <td height="24">&nbsp;</td>
			              <td>&nbsp;</td>
			              <td colspan="2"><input type="radio" name="statnum" id="Tidak_num" disabled="disabled">
			              Tidak</td>
			            </tr>
			            <tr>
			              <td>Denominator</td>
			              <td>:</td>
			              <td colspan="2"><input type="radio" name="statden" id="Ya_den" checked disabled="disabled">Ya</td>
			            </tr>
			            <tr>
			              <td height="24">&nbsp;</td>
			              <td>&nbsp;</td>
			              <td colspan="2"><input type="radio" name="statden" id="Tidak_den" disabled="disabled">
			              Tidak</td>
			            </tr>
						<tr>
						  <td>Departemen</td>
