...
date_default_timezone_set("Asia/Bangkok");
	 ...
	 // Check If form submitted, insert form data into users table.
		 ...
		 $Date_kira_2	= substr($perkiraan_waktu_2,6,4)."-".substr($perkiraan_waktu_2,3,2)."-".substr($perkiraan_waktu_2,0,2);
			...
			$sql = "UPDATE T_Invest SET Penyebab = '".$penyebab_langsung."', Akar_mslh = '".$akar_masalah."', Pendek = '".$tindakan."', Pj_1 = '".$penanggung_jawab_1."', Waktu_1 = '".$Date_kira_1."' , Panjang = '".$rekomendasi."', Pj_2 = '".$penanggung_jawab_2."', Waktu_2 = '".$Date_kira_2."' WHERE No_invest = '".$no_invest."'";
