        ...
        <div class="span12 mainPage">
          ...
          <table>
            ...
            <tr>
              <td>No. Laporan</td>
              <td> : </td>
              <td><input type="text" id="no_lap" name="no_lap" maxlength="17"></td>
            </tr>
            <tr>
              <td>Penyebab langsung insiden</td>
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea rows="4" id="penyebab_langsung" name="penyebab_langsung" maxlength="50"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea rows="4" id="akar_masalah" name="akar_masalah" maxlength="50"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td> : </td>
              <td colspan="2" rowspan="2"><textarea rows="4" id="tindakan" name="tindakan" maxlength="50"></textarea></td>
            </tr>
            <tr>
              <td height="42">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>No. RCA</td>
              <td> : </td>
              <td><input type="text" id="no_rca" name="no_rca" maxlength="20"></td>
            </tr>
            <tr>
              <td height="43">&nbsp;</td>
              <td>&nbsp;</td>
