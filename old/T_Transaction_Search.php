...
<div id="myModal" class="modala">
  ...
  <div class="modala-body">
      <p>Pilih Data Transaksi yang dimaksud</p>
      <table>
          <tr>
...
$(document).ready(function(){
    ...
    {
        $("#tampiltabel").load('T_Transaction_Table.php?katakunci='+$("#katakunci").val());
    });
});
...
function cekKataKunci(){
    ...
    window.location.href='T_Transaction_Search.php?katakunci=' + katakunci;
}
