    ...
    <div class="container">
      <div class="row">
        <div class="span12 mainPage">
          ...
          <p><span class="style1">Create Transaction</span></p>
          ...
          <table width="1048">
            <tr>
			  ...
			  <td><input name="id" type="text" id="id" value="<?php echo $id;?>" size="8" maxlength="6" readonly="readonly"
			  style="text-align:center;font-weight:bold;font-size:16px" /></td>
			  <td width="532" rowspan="8"><iframe src="./uploadpage.php" height="275" width="390"></iframe></td>
             
			 <!-- <td rowspan="6"><p>File Upload:
            ...
            <tr>
              <td width="195">Aspek</td>
              <td width="10">:</td>
              <td width="296"><span class="inputan">
                <select id="aspek" name="aspek" style="width:auto">
            ...
            <tr>
              <td>Status</td>
              <td>:</td>
              <td><input type="radio" name="statinput" id="Selesai" checked>
              Selesai</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="43">&nbsp;</td>
              <td>&nbsp;</td>
              <td colspan="3"><button onClick="saveinput();">Save</button>  
            <button onClick="clearinput();">Reset</button></td>
            </tr>
          </table>
          </form>
<p> 
            <?php //include "Transaction_Search.php"; ?>
          </p>
